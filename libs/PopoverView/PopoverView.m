...
- (void)showAtPoint:(CGPoint)point inView:(UIView *)view withContentView:(UIView *)cView {
    ...
    tap.delegate = self; //////////added by Terry//////////
    ...
    [UIView animateWithDuration:0.2f delay:0.f options:UIViewAnimationCurveEaseInOut animations:^{   ///////linlipeng 0.2 -> 0.05
        self.alpha = 1.f;
...
- (void)dismiss {
    [UIView animateWithDuration:0.3f animations:^{   /////////linlipeng 0.3->0.05
        self.alpha = 0.1f;
        self.transform = CGAffineTransformMakeScale(0.1f, 0.1f);
    } completion:^(BOOL finished) {
...
//{
//    CGRect contentRect = [self.contentView convertRect:self.contentView.bounds toView:self];
//    CGRect touchRect = [touch.view convertRect:touch.view.bounds toView:self];
//    
//    if (CGRectContainsRect(contentRect, touchRect)) {
//        return NO;
//    }else{
//        return YES;
//    }
//}
//////////end of added by Terry//////////
